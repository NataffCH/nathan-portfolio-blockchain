    ...
    <Box>
      ...
      >
        ...
        <Box mt="5px">
          ...
          >
            Proficient in Ethereum, Solana, Solidity and Rust. <br></br>
            Mainly responsible for the development of Trading bots, Market
            making bots, Sniping bots, Arbitrage bots. <br></br>
            As a senior blockchain bot developer and web front-end developer,
            please feel free to reach out to me to make a <h1>huge profit.</h1>
          </Text>
        </Box>
